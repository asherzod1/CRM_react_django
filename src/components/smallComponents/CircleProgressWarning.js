...
function CircleProgressWarning(props) {
    let value = 60
    return (
        <div className='circle-chart'>
            <div className='circle-chart__left'>
                ...
                <div className="circle-chart__left__bottom">
                    ...
                    <div>
                        <img src="imga/progress_w.png" alt=""/>
                        <span style={{background:'#FFCA26'}}>
                            7 %
                        </span>
                    </div>
                </div>
...
export default CircleProgressWarning;